...
export default function AnimatedLetter({
  ...
  const phaseOffset = useMemo(
    () => index * FLOATING_CONFIG.PHASE_OFFSET,
    [index]
  );
  ...
  useFrame((state) => {
    ...
    const secondaryPitch =
      Math.sin(time * FLOATING_CONFIG.SECONDARY_PITCH_SPEED) *
      secondaryPitchAmplitude;
    const secondaryYaw =
      Math.cos(time * FLOATING_CONFIG.SECONDARY_YAW_SPEED) *
      secondaryYawAmplitude;
    const secondaryRoll =
      Math.cos(time * FLOATING_CONFIG.SECONDARY_ROLL_SPEED) *
