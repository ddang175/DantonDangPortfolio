...
const CardModal: React.FC<CardModalProps> = ({ 
  ...
  return (
    <div 
      className="fixed inset-x-0 z-45 flex items-end justify-center p-4 pointer-events-none"
      style={{ 
    ...
    >
      ...
      <div 
        className={`
          relative w-full max-w-4xl overflow-hidden pointer-events-auto
      ...
      >
        ...
        <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl h-full">
          <div 
            className="transition-opacity duration-150 ease-out h-full overflow-y-auto"
            style={{ opacity: contentOpacity }}
          >
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-white/10 sticky top-0 bg-black/80 backdrop-blur-sm z-10">
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              {/* Text Section */}
              <div className={`w-full ${(card.modalImageUrl || card.imageUrl) ? 'lg:w-1/2' : ''} p-6`}>
