  ...
  return (
    <button
      ...
      className={`
        ...
        ${
          isActive
            ? "border-purple-400/50 bg-purple-900/20 scale-102 shadow-lg shadow-purple-500/20"
            : "scale-100"
        }
    ...
    >
      ...
      <div
        ...
        } rounded-lg overflow-hidden bg-black/30 border border-white/10 flex-shrink-0
        transition-all duration-300 ease-out
