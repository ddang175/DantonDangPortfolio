...
export default function ExperienceButton({ onButtonClick, className = '', style }: ExperienceButtonProps) {
  const ANIMATION_CONFIG = {
    FADE_OUT_DURATION: 300,
    TEXT_ANIMATION_DELAY: 300,
    CURSOR_RETURN_SPEED: 0.97, // more subtle, returns to center faster
    CURSOR_INFLUENCE_RADIUS_X: 150, // wider horizontally
    CURSOR_INFLUENCE_RADIUS_Y: 80,  // less vertically
    CURSOR_FOLLOW_SPEED: 0.005, // slower follow for subtle effect
    HOVER_SCALE: 1.1,
